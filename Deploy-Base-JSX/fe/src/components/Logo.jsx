...
export default function Logo({ className = 'h-9 w-auto' }) {
  return (
    <svg viewBox="0 0 240 50" fill="none" role="img" aria-label="Veloce Motors" className={className}>
      <rect width="42" height="42" y="4" rx="10" fill="#0F172A" stroke="var(--color-outline-variant)" strokeWidth="1" />
      <path
      ...
      />
      <path d="M22 19L27 19" stroke="#60A5FA" strokeWidth="2" strokeLinecap="round" />
